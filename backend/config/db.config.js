...
db.useraccount = require("../models/useraccount.model.js")(
  sequelize,
  Sequelize
);
db.employee = require("../models/employee.model.js")(sequelize, Sequelize);
db.employeeschedule = require("../models/employeeschedule.model.js")(
  sequelize,
  Sequelize
);
...
//many to many
db.employee.belongsToMany(db.schedule, {
  through: "employeeschedule",
  foreignKey: "employeeId",
});
db.schedule.belongsToMany(db.employee, {
  through: "employeeschedule",
...
db.useraccountemployee = db.useraccount.belongsTo(db.employee, {
  foreignKey: "employeeId",
});
